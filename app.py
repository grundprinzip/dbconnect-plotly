...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div([
            html.H2("NYC Taxi analysis (data processing on Databricks)", className="text-xl mt-4 mb-4 text-red-500 font-bold"),
            html.P("""The below visualization uses a heatmap display based on georcordinates for
         either the pickup or dropoff dimension and a second dimension is used for coloring. """),
            ...
            html.Div([
                ...
                html.Div(
                    dcc.Dropdown(['avg_trip_duration', 'cout_trips', 'avg_trip_distance'], 'avg_trip_duration',
                                 id='Map-dropdown-agg')),
            ], className="columns-2", ),
            dcc.Graph(id="NYC-zip-map-analysis"),
            html.H2("Example Code", className="text-xl mt-4 mb-4 text-red-500 font-bold"),
            html.Div([
                html.Pre("""
@app.callback(
...
def update_output(zip_plot, column_map_show):
    ...
    return px.choropleth_mapbox(df_map_show,
        ...
        html.Div([
            html.H2("Trips by pickup zip(data processing on Databricks)", className="text-xl mt-4 mb-4 text-red-500 font-bold"),
            html.P(),
            html.Div(
